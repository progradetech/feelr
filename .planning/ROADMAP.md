...
Plans:
- [x] 14-01-PLAN.md -- Create SWA config files, fix Turborepo caching, provision Azure resources, and deploy both apps
- [x] 14-02-PLAN.md -- Wire custom domains with TXT verification and managed SSL certificates
